          ...
          <div className="rounded-lg bg-accent p-4 flex flex-col gap-y-4 w-full">
            ...
            <div className="flex w-full justify-between items-center">
              <div className="flex flex-col">
                ...
                <span className="text-primary-foreground font-bold text-md">VALOR {formatBRL(turn.value)}</span>
              </div>
            ...
            <div className="flex w-full justify-between items-center">
              {turn.prizes.map((prize, j) => (
                <div className="flex-grow flex flex-col items-center justify-center">
                  ...
                  <span className="text-md text-primary-foreground font-bold">{formatBRL(prize)}</span>
                </div>
              ))}
            </div>
          </div>
